...
class Reppn extends Module
{

	public function __construct()
	{
		$this->name = 'prestachup';             // internal identifier, unique and lowercase
		$this->tab = 'front_office_features';   // backend module coresponding category
		$this->version = '1.0.0';               // version number for the module
		$this->author = 'Prestachup';           // module author
		$this->need_instance = 0;               // load the module when displaying the "Modules" page in backend
		$this->bootstrap = true;

		parent::__construct();

		$this->displayName = $this->l('Repp\'n Module'); // public name
		$this->description = $this->l('Repp\'n customization module'); // public description
    ...
    /**
     * Hook custom example - Register it in __construct.
     * * * * * * * * * * * * * * * * * * * * * * * * * *
     */
    public function hookDisplayCustomHook()
    {
